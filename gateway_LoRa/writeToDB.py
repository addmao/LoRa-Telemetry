...
def insertDataToDB(data_read):
	...
	while True:
		...
		water_level_data = data_read.split(",")[3]
		temp_data = data_read.split(",")[0]
		humid_data = data_read.split(",")[1]
		rssi_data = data_read.split(",")[2]
		
		print "water level" + water_level_data
		print "temp_data" + temp_data
		print "humid_data" + humid_data
		print "rssi_data" + rssi_data
		...
		sql_query = ("""INSERT INTO monitoring_system (water_level, temp, humid, rssi, datetime) VALUES (%s, %s, %s, %s, %s)""",(water_level_data, temp_data, humid_data, rssi_data, datetimeWrite))
